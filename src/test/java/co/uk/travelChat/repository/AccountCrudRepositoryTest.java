...
public class AccountCrudRepositoryTest {
    ...
    public void setUp() throws Exception {
        ...
        accountCrudRepository.save(new Account(DEFAULT_NICKNAME, DEFAULT_NAME, DEFAULT_TRIPS)).subscribe();
...
//    }
    ...
    public void findAccountsByName() {
        Flux<Account> accountMono = accountCrudRepository.getAllByName(DEFAULT_NAME);
